                ...
                <div class="settings-section">
                    ...
                    <button class="btn theme-toggle-btn" id="themeToggleBtn">
                        ${isDark
                            ...
                            : `<svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" stroke="none" style="vertical-align:-2px;margin-right:6px"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>Switch to Dark`
                        }
                    </button>
                </div>
                ${renameSection}
